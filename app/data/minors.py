...
def process_minors(file_path):
    file_name = os.path.basename(file_path)
    print(f"\nUpdating minors from {file_name}")

    # Define the cell ranges and expected columns for each table
    table_ranges = {
        'MINORS': ('A1:E100', ['NAME', 'LEVEL1_CREDITS', 'ADVANCED_CREDITS', 'DEPARTMENT', 'NOTES']),
        'MINOR_LEVEL1_COURSES': ('G1:H100', ['MINOR', 'COURSE']),
        'MINOR_ADVANCED_COURSES': ('J1:K100', ['MINOR', 'COURSE']),
        'MINOR_COURSE_ALTERNATIVES': ('M1:O100', ['MINOR', 'COURSE', 'ALTERNATIVE']),
        'MINOR_DEPARTMENTAL_REQUIREMENTS': ('Q1:T100', ['MINOR', 'DEPARTMENT', 'CREDITS_REQUIRED', 'LEVEL']),
        'MINOR_RECOMMENDED_COURSES': ('V1:W100', ['MINOR', 'COURSE']),
        'MINOR_OPTIONAL_ADVANCED_COURSES': ('Y1:Z100', ['MINOR', 'COURSE']),
        'MINOR_REQUIREMENT_FROM_OPTIONAL_ADVANCED_COURSES': ('AB1:AD100', ['MINOR', 'NUMBER_OF_COURSES_REQUIRED', 'CREDITS_REQUIRED']),
        'MINOR_OPTIONAL_CORE_COURSES_SET1': ('AF1:AG100', ['MINOR', 'COURSE']),
        'MINOR_OPTIONAL_CORE_COURSES_SET2': ('AI1:AJ100', ['MINOR', 'COURSE']),
        'MINOR_OPTIONAL_CORE_COURSES_SET3': ('AL1:AM100', ['MINOR', 'COURSE']),
        'MINOR_REQUIREMENT_FROM_OPTIONAL_CORE_COURSES_SET1': ('AO1:AQ100', ['MINOR', 'NUMBER_OF_COURSES_REQUIRED', 'CREDITS_REQUIRED']),
        'MINOR_REQUIREMENT_FROM_OPTIONAL_CORE_COURSES_SET2': ('AS1:AU100', ['MINOR', 'NUMBER_OF_COURSES_REQUIRED', 'CREDITS_REQUIRED']),
        'MINOR_REQUIREMENT_FROM_OPTIONAL_CORE_COURSES_SET3': ('AW1:AY100', ['MINOR', 'NUMBER_OF_COURSES_REQUIRED', 'CREDITS_REQUIRED'])
    }
    ...
    try:
        ...
        print("The 'Minors' sheet was not found in the Excel file.")
        return
...
def insert_into_table(table_name, expected_columns, row, cur):
    primary_keys = {
        "MINORS": "NAME",
        "MINOR_LEVEL1_COURSES": "MINOR, COURSE",
        "MINOR_ADVANCED_COURSES": "MINOR, COURSE",
        "MINOR_COURSE_ALTERNATIVES": "MINOR, COURSE, ALTERNATIVE",
        "MINOR_DEPARTMENTAL_REQUIREMENTS": "MINOR, DEPARTMENT",
        "MINOR_RECOMMENDED_COURSES": "MINOR, COURSE",
        "MINOR_OPTIONAL_ADVANCED_COURSES": "MINOR, COURSE",
        "MINOR_REQUIREMENT_FROM_OPTIONAL_ADVANCED_COURSES": "MINOR",
        "MINOR_OPTIONAL_CORE_COURSES_SET1": "MINOR, COURSE",
        "MINOR_REQUIREMENT_FROM_OPTIONAL_CORE_COURSES_SET1": "MINOR",
        "MINOR_OPTIONAL_CORE_COURSES_SET2": "MINOR, COURSE",
        "MINOR_REQUIREMENT_FROM_OPTIONAL_CORE_COURSES_SET2": "MINOR",
        "MINOR_OPTIONAL_CORE_COURSES_SET3": "MINOR, COURSE",
        "MINOR_REQUIREMENT_FROM_OPTIONAL_CORE_COURSES_SET3": "MINOR",
    }
